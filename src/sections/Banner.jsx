        ...
        <div key={index}>
          ...
          >
            <div className="m-0 overflow-hidden p-2 text-bluewood sm:mx-[1%] sm:mb-[41px] md:mb-[110px] lg:ml-[45px] lg:mr-[150px] xl:mx-[286px] 2xl:mx-[392px]">
              <h1 className="leading-150 mr-[12%] p-[41px_32px_32px_13px] text-[22px] font-bold sm:mt-[41px] sm:p-[126px_15%_32px_15px] sm:text-[38px] lg:mr-0 lg:mt-[130px] lg:p-[0_8px_50px_8px] xl:p-[0_30%_2%_0] 2xl:p-[0_45%_2%_0]">
                {item.text}{" "}
